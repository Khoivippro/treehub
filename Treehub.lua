...
ImageButton.Image = "rbxassetid://17382473215" -- กำหนดรูปภาพให้กับ ImageButton 
...
--[[page/Tab]]
    ...
    local Library = Update:Window("Tree Hub","",Enum.KeyCode.F1);
...
page1:Label("Join My Discord For More News!")
    page1:Button("Copy Discord Link",function()
         setclipboard("Chào mn người 🤡")
         game:GetService("StarterGui"):SetCore("SendNotification",{Title = "TreeHub",Text = "Successfully copied",Icon = "rbxassetid://17382473215",Duration = 3})
    end)
else
page1:Label("เข้าดิสคอร์ดเพื่อข่าวสารต่างๆ")
    page1:Button("ก็อปปี้ลิ้งดิสคอร์ด",function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification",{Title = "TreeHub",Text = "คัดลอกเรียบร้อยแล้ว",Icon = "rbxassetid://17382473215",Duration = 3})
    end)
end
...
Vec("<Color=Yellow>Tree Hub loaded successfully<Color=/>")                                                               
page2:Seperator("⚙️")
if _G.Mode == "English"then
